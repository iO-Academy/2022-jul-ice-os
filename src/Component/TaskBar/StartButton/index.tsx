        ...
        <div className="startMenu">
            <div>
                <button onClick={showMenu} className="startButton">
                    <img className="startButtonImage" src={process.env.PUBLIC_URL + "/assets/Desktop/Images/icebergStartMenuIcon.png"}
            ...
            <div className="menuDisplay" id="menu">
                <div className={"menuSpacer"}>
                    <img className={"menuImage"} src={process.env.PUBLIC_URL + "/assets/Desktop/Images/menuImage.png"}
                         alt="Penguin in a igloo"/>
                    <p className={"userInMenu"}>Nico</p>
                </div>
                <div>
                    <ul className={"menuList"} onClick={openAboutApplication}>
                        <img className={"menuListImage"} src={process.env.PUBLIC_URL + "/assets/Desktop/Images/AboutImage.png"}
                             alt="Penguin reading a book"/>
                        <p className={"menuListText"}>About</p>
                    </ul>
                    <ul className={"menuList"} onClick={openSurfApplication}>
                        <img className={"menuListImage"} src={process.env.PUBLIC_URL + "/assets/Desktop/Images/surfWaveFury.png"} alt="Surfing penguin, from the amazing game SurfWave Fury"/>
                        <p className={"menuListText"}>SurfWave Fury</p>
                    </ul>
                    <ul className={"menuList"} onClick={openMusicApplication}>
                        <img className={"menuListImage"} src={process.env.PUBLIC_URL + "/assets/Desktop/Images/musicPenguin.png"}
                             alt="Penguin listening to music"/>
                        <p className={"menuListText"}>Music</p>
                    </ul>
                     <ul className={"menuList"} onClick={openGifApplication}>
                    <img className={"menuListImage"} src={process.env.PUBLIC_URL + "/assets/Desktop/Images/gifWatchingPenguin.png"}
                ...
                <div className={"menuSpacer2"}>
                    <div className={"menuButtonsContainer"}>
                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
                            <img className={"logoutButton"} src={process.env.PUBLIC_URL + "/assets/Desktop/Images/logout.png"}
                                 alt="Logout penguin"/>
